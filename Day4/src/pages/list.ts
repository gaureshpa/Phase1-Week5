...
export function renderListPage(state: PageState): HTMLDivElement {
...
function showAddExpenseModal(): void {
...
function showEditExpenseModal(transaction: Transaction): void {
    const form = document.createElement("form");
